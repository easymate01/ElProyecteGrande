    ...
    <article className="tile">
      <div className="tile-header">
        <div>
          ...
          {myAccount ? (
            <div className="buttons-myacc">
              <button className="product-myacc-btn edit-btn" onClick={onEdit}>
                <svg
              ...
              <button
                className="product-myacc-btn delet-btn"
                onClick={onDelete}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button className="product-myacc-btn sold-btn">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
